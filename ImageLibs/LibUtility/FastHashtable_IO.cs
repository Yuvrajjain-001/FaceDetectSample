...
namespace Dpu.Utility
{
    ...
    public class FastHashtableIO  
    {
        ...
        #region Construtors 
        public FastHashtableIO (int size, double loadFactor)
        {
...
//#endif // INTERNAL_DPU
        ...
        /// </summary>
        public void Copy(FastHashtableIO toTable)
        {
            this.Reset();
            while(this.MoveNext()) 
            {
        ...
        {
            FastHashtableIO tmp = new FastHashtableIO(m_size * 2, m_loadFactor);
            this.Copy(tmp);
...
//#if INTERNAL_DPU
        ...
        /// </summary>
        public FastHashtableIO Clone()
        {
            FastHashtableIO res = new FastHashtableIO(m_size, m_loadFactor);
...
//#if INTERNAL_DPU
        ...
        {
            Console.WriteLine("*********************************************");
            Console.WriteLine("Testing FastHashtableIO");
            int ntest = 1000000;
            int nloop = 5;
            ...
            FastHashtableIO table = new FastHashtableIO(ntest, 0.5f);
